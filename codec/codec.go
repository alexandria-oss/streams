...
type Codec interface {
	// Encode the given input into an array of bytes using an underlying serialization type.
	Encode(v any) ([]byte, error)
	// Decode the given input of an array of bytes into a Go type using an underlying serialization type.
	//
